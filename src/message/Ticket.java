...
/**
 * After checking the SearchOrder in the database, we should create an object of
 * OrderResult, and returnif to Client.
 * 
 * Information: 0.transaction_number 1.carID; 2.userID; 3.depart station;
 * 4.arrive station; 5.depart_time; 6.arrive_time; 7.passenger_type; 8.carriage;
 * 9.early_discount(65,75...or none) 10.compartment 11.location
 *
 */
public class Ticket implements Serializable {
	...
	*/
	...
	private String location; // sending to sever == seat Type {WINDOW, NONE, AISLE} sending to client = A2
								// E19.....
	 ...
	 */
	public Ticket() {
		transaction_number = carID = userID = depart = arrive = depart_time = arrive_time = passenger_type = carriage = early_discount = university_discount = compartment = location = price = "invalid";
	 ...
	 * 
	 * @param (String
	 *            transaction_number, String carID, String userID, String depart,
	 *            String arrive, String depart_time, String arrive_time, String
	 *            passenger_type, String carriage, String early_discount,String
	 *            university_discount, String compartment, String location, String
	 *            price)
	 */
