 ...
 * 1.depart station 
 * 2.arrive station 
 * 3.passenger type(NORMAL,
 * CHILD, ELDER, DISABLE, STUDENT) 
 * 4.seat(NONE, WINDOW, AISE)
 * 5.carriage(STANDARD, BUSINESS) 
 * 6.quantity(it means the numbers of different
 * kinds of tickets the user want to buy) 
 * 7.total(the total number of the
 * tickets that user wants to buy) 
 * 8.depart time 
 * 9.direction(it's a int type, 1
 * means toward north , 0 means toward south)
 */
